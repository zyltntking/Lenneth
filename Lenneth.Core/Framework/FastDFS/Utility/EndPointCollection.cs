...
{
    public sealed class EndPointCollection : Collection<IPEndPoint>
    {
        /// <summary>
        ...
        public EndPointCollection(IList<IPEndPoint> endpoints) : base(endpoints) { }

        /// <summary>
        /// Format an endpoint
        /// </summary>
        /// <param name="endpoint">The endpoint to get a string representation for.</param>
        public static string ToString(IPEndPoint endpoint) => Format.ToString(endpoint);

        /// <summary>
        /// Attempt to parse a string into an EndPoint
        /// </summary>
        /// <param name="endpoint">The endpoint string to parse.</param>
        public static IPEndPoint TryParse(string endpoint) => Format.TryParseEndPoint(endpoint);
        ...
        protected override void InsertItem(int index, IPEndPoint item)
        {
            ...
            if (Contains(item)) throw new ArgumentException("IPEndPoints must be unique", nameof(item));
