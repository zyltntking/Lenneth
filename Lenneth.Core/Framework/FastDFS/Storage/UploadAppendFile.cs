...
namespace Lenneth.Core.Framework.FastDFS.Storage
{
    using Common;
    ...
    /// </summary>
    internal class UploadAppendFile : FdfsRequest
    {
        private UploadAppendFile()
        {
        }

        public static UploadAppendFile Instance { get; } = new UploadAppendFile();
        ...
        public override FdfsRequest GetRequest(params object[] paramList)
        {
            ...
            var result = new UploadAppendFile { Connection = ConnectionManager.GetStorageConnection(endPoint) };
            ...
            result.Header = new FdfsHeader(length, Consts.StorageProtoCmdUploadAppenderFile, 0);
            return result;
        }
