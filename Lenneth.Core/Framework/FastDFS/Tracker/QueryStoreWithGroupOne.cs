...
namespace Lenneth.Core.Framework.FastDFS.Tracker
{
    using Common;
    ...
    internal class QueryStoreWithGroupOne : FdfsRequest
    {
        ...
        public static QueryStoreWithGroupOne Instance { get; } = new QueryStoreWithGroupOne();
        ...
        public class Response
        {
            ...
            public readonly string IpStr;
            public readonly int Port;
            public readonly byte StorePathIndex;
