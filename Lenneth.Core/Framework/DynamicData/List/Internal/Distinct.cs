...
namespace Lenneth.Core.Framework.DynamicData.List.Internal
{
    internal sealed class Distinct<T, TValue>
    {
        ...
        private sealed class ItemWithMatch : IEquatable<ItemWithMatch>
        {
            ...
            /// <summary>Returns a value that indicates whether the values of two <see cref="T:Lenneth.Core.Framework.DynamicData.List.Internal.Filter`1.ItemWithMatch" /> objects are equal.</summary>
            ...
            /// <summary>Returns a value that indicates whether two <see cref="T:Lenneth.Core.Framework.DynamicData.List.Internal.Filter`1.ItemWithMatch" /> objects have different values.</summary>
            /// <param name="left">The first value to compare.</param>
            /// <param name="right">The second value to compare.</param>
