...
namespace Lenneth.Core.Framework.DynamicData.List.Internal
{
    internal sealed class GroupOnImmutable<TObject, TGroupKey>
    {
        ...
        public IObservable<IChangeSet<global::Lenneth.Core.Framework.DynamicData.List.IGrouping<TObject, TGroupKey>>> Run()
        {
        ...
        private sealed class ItemWithGroupKey : IEquatable<ItemWithGroupKey>
        {
            ...
            /// <summary>Returns a value that indicates whether the values of two <see cref="T:Lenneth.Core.Framework.DynamicData.List.Internal.GroupOn`2.ItemWithGroupKey" /> objects are equal.</summary>
            ...
            /// <summary>Returns a value that indicates whether two <see cref="T:Lenneth.Core.Framework.DynamicData.List.Internal.GroupOn`2.ItemWithGroupKey" /> objects have different values.</summary>
            /// <param name="left">The first value to compare.</param>
            /// <param name="right">The second value to compare.</param>
