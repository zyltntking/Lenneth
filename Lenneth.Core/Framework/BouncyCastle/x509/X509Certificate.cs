...
using Lenneth.Core.FrameWork.BouncyCastle.asn1.misc;
using Lenneth.Core.FrameWork.BouncyCastle.asn1.util;
using Lenneth.Core.FrameWork.BouncyCastle.asn1.x509;
using Lenneth.Core.FrameWork.BouncyCastle.crypto;
using Lenneth.Core.FrameWork.BouncyCastle.crypto.operators;
...
using Lenneth.Core.FrameWork.BouncyCastle.util.encoders;
using Lenneth.Core.FrameWork.BouncyCastle.x509.extension;
...
//        }
		...
		/// <summary>
        /// Return a <see cref="BigInteger">BigInteger</see> containing the serial number.
        /// </summary>
