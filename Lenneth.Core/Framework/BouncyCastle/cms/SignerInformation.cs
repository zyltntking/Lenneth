...
using IssuerAndSerialNumber = Lenneth.Core.FrameWork.BouncyCastle.asn1.cms.IssuerAndSerialNumber;
using SignerInfo = Lenneth.Core.FrameWork.BouncyCastle.asn1.cms.SignerInfo;
using Time = Lenneth.Core.FrameWork.BouncyCastle.asn1.cms.Time;
