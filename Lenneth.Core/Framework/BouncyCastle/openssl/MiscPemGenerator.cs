...
using Lenneth.Core.FrameWork.BouncyCastle.util.io.pem;
using Lenneth.Core.FrameWork.BouncyCastle.x509;
using ContentInfo = Lenneth.Core.FrameWork.BouncyCastle.asn1.cms.ContentInfo;
    ...
    */
        ...
        : PemObjectGenerator
    {
        ...
        private static PemObject CreatePemObject(object obj)
        {
            ...
            else if (obj is ContentInfo)
            {
                type = "PKCS7";
                encoding = ((ContentInfo)obj).GetEncoded();
            }
            else
            {
