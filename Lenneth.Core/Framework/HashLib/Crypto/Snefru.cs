...
{
    internal class Snefru_4_128 : Snefru
    {
        public Snefru_4_128()
            : base(HashRounds.Rounds4, HashLib.HashSize.HashSize128)
        {
        }
    }

    internal class Snefru_4_256 : Snefru
    {
        public Snefru_4_256()
            : base(HashRounds.Rounds4, HashLib.HashSize.HashSize256)
        {
        }
    }

    internal class Snefru_8_128 : Snefru
    {
        public Snefru_8_128()
            : base(HashRounds.Rounds8, HashLib.HashSize.HashSize128)
        {
        }
    }

    internal class Snefru_8_256 : Snefru
    {
        public Snefru_8_256()
            : base(HashRounds.Rounds8, HashLib.HashSize.HashSize256)
        {
        }
    }

    internal abstract class Snefru : BlockHash, ICryptoNotBuildIn
    {
        #region Consts
        ...
        protected Snefru(HashRounds a_rounds, HashSize a_hash_size)
            : base((int)a_hash_size, 64 - ((int)a_hash_size))
        {
