...
namespace Lenneth.Core.Framework.LiteDB
{
    ...
    public class StringScanner
    {
        ...
        /// </summary>
        public void Seek(int length) => Index += length;
        ...
        /// </summary>
        public string Scan(string pattern) => Scan(new Regex((pattern.StartsWith("^") ? "" : "^") + pattern, RegexOptions.IgnorePatternWhitespace));
        ...
        /// </summary>
        public string Scan(string pattern, int group) => Scan(new Regex((pattern.StartsWith("^") ? "" : "^") + pattern, RegexOptions.IgnorePatternWhitespace), group);
        ...
        /// </summary>
        public bool Match(string pattern) => Match(new Regex((pattern.StartsWith("^") ? "" : "^") + pattern, RegexOptions.IgnorePatternWhitespace));
        ...
        public void ThrowIfNotFinish()
        {
            ...
            if (!HasTerminated) throw LiteException.SyntaxError(this);
        }
    }
}