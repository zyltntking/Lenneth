...
using Lenneth.WebApi.Resources;
...
namespace Lenneth.WebApi
{
    ...
    internal static class WebApiConfig
    {
        ...
        internal static void Register(HttpConfiguration config)
        {
            ...
            config.EnableSwagger("apiInfo/{apiVersion}", swagger =>
            {
                ...
                swagger.ApiKey(AppResource.ApiKeyHeader)
                    .Description("API Key Authentication")
                    .Name(AppResource.ApiKeyHeader)
                    .In("header");
                //
            ...
            }).EnableSwaggerUi("Document/{*assetPath}"/*"Swagger/{*assetPath}"*/, swaggerui =>
            {
                ...
                //);
                swaggerui.EnableApiKeySupport(AppResource.ApiKeyHeader, "header");
            });
    ...
    internal class HttpHeaderTokenAuth : IOperationFilter
    {
        ...
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            ...
            {
                operation.parameters.Add(new Parameter { name = AppResource.TokenHeader, @in = "header", description = "用户令牌", required = false, type = "string" });
            }
        }
