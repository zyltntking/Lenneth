...
namespace Lenneth.WebApi
{
    ...
    public class Global : HttpApplication
    {
        ...
        private void Application_BeginRequest()
        {
            ...
            if (Request.Url.AbsolutePath.Contains(Resources.AppResource.WebApiPath))
            {
                var log = UnityConfig.Container.Resolve<ILogWapper>(Resources.AppResource.WebApiRequestLogName);
